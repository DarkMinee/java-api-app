...
import org.jhipster.api.repository.StudentRepository;
...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().name(DEFAULT_NAME).surname(DEFAULT_SURNAME).date(DEFAULT_DATE);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().name(UPDATED_NAME).surname(UPDATED_SURNAME).date(UPDATED_DATE);
        return student;
    }
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getDate()).isEqualTo(DEFAULT_DATE);
    }
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.name(UPDATED_NAME).surname(UPDATED_SURNAME).date(UPDATED_DATE);
        ...
        assertThat(testStudent.getDate()).isEqualTo(UPDATED_DATE);
    }
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.date(UPDATED_DATE);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.name(UPDATED_NAME).surname(UPDATED_SURNAME).date(UPDATED_DATE);
